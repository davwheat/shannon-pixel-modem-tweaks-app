...
class AdditionalNrSaLocking : NvItemTweak() {
  ...
  override val description = "Adds n1/2/3/5/7/8/12/20/25/26/28/29/30/38/40/41/48/66/70/71/77/78 to supported NR SA bands"

  private val bands = listOf(1, 2, 3, 5, 7, 8, 12, 20, 25, 26, 28, 29, 30, 38, 40, 41, 48, 66, 70, 71, 77, 78)
